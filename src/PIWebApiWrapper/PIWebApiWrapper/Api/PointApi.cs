...
namespace PIWebAPIWrapper.Api
{
	...
	[Guid("93958311-DD0E-49AA-922D-B4C4CBD575CD")]
	[ComVisible(true)]
	...
	[Guid("F11326B9-BE51-4D19-A8EC-441577FFB804")]
	[ComVisible(true)]
	...
	public class PointApi : IPointApi
	{
		...
		public ApiResponsePIItemsPointAttribute GetAttributesWithHttpInfo(string webId, string names = null, string nameFilter = null, string selectedFields = null, string webIdType = null)
		{
			...
			if (webId!= null) localVarPathParams.Add("webId", Configuration.ApiClient.ParameterToString(webId));
			localVarQueryParams.Add("name", Configuration.ApiClient.ParameterToString(name), true);
